...
import { BOOKING_DISPLAY_TTL_HOURS } from '../../../../lib/booking'
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <div className="text-center mb-8">
          ...
          <p className="text-stone-500 mt-2 text-sm sm:text-base">
            Transfer payment within <strong>{displayHours} hours</strong> to confirm your booking.
          </p>
        </div>
        ...
        <section className="bg-gradient-to-br from-[#2C1F0E] to-[#1a130a] text-stone-200 rounded-2xl p-5 sm:p-7 mb-5 text-center">
          <p className="text-[#C4A348] text-xs font-bold uppercase tracking-widest mb-3">
            Next step
          </p>
          <p className="text-sm text-stone-300 mb-5 leading-relaxed">
            Visit your booking portal to choose how much to pay — deposit, full amount, or anywhere in between — and view your bank transfer details.
          </p>
          <Link
            href={`/portal?code=${encodeURIComponent(reservation.reservation_code)}`}
            className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-[#C4A348] text-white font-semibold text-sm hover:bg-[#b2932e] transition"
          >
            Go to my portal →
          </Link>
        </section>
        ...
        <section className="bg-white rounded-2xl border border-stone-200 p-5 sm:p-7 mb-8">
          ...
          <ol className="list-decimal pl-5 text-sm text-stone-600 space-y-2">
            <li>Go to your portal and choose your payment amount.</li>
            <li>
              Bank transfer that amount using your{' '}
              <strong>reservation number ({reservation.reservation_code})</strong> as the reference.
            </li>
            <li>
              In the portal, click <em>&ldquo;I&rsquo;ve sent my payment&rdquo;</em>. We&apos;ll confirm receipt and lock in your place.
            </li>
          </ol>
